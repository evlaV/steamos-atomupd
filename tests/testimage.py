...
image_status = [
    ...
    ImageStatus(
        ...
        generic_update_path='steamos/amd64/3.7.1/steamdeck-main.1.json',
        is_checkpoint=True,
        image_checkpoint=1,
    ),
    ...
    ImageStatus(
        ...
        generic_update_path='steamos/amd64/3.7.2/steamdeck-main.1.json',
        image_checkpoint=1,
    ),
    ...
    ImageStatus(
        ...
        generic_update_path='steamos/amd64/3.7.5/steamdeck-main.2.json',
        is_checkpoint=True,
        image_checkpoint=2,
    ),
]
